"""Regression checks for the notion-ui-viewer-kit casebook."""
...
from casebook.harness import assert_expected, notion_ui_viewer_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_ui_viewer_kit_summary(), assert_expected())
